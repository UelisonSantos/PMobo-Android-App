...
public class ListeningNomeProjeto  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listening_nome_projeto);
    ...
    public void onSpeechButtonClicked(View v) {
        ...
        try {
            ...
            if (result.getReason() == ResultReason.RecognizedSpeech) {
                ...
                Intent intent = new Intent(this, ListeningDataInicio.class);
                intent.putExtra("NomeProjeto", result.getText());
